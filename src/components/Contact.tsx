  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "bhushanahire594@gmail.com",
      link: "mailto:bhushanahire594@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 9850701805",
      link: "tel:+919850701805"
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      username: "bhushanahire94",
      url: "https://github.com/bhushanahire94"
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
            ...
            <div>
              ...
              <div className="mt-8">
                <Button 
                  ...
                  asChild
                >
                  <a href="mailto:bhushanahire594@gmail.com">
